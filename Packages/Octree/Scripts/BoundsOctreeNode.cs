...
namespace Octree
{
    public partial class BoundsOctree<T>
    {
        ...
        private class Node
        {
            ...
            public Node(float baseLengthVal, float minSizeVal, float loosenessVal, float3 centerVal)
            {
            ...
            public int BestFitChild(float3 objBoundsCenter)
            {
            ...
            private void SetValues(float baseLengthVal, float minSizeVal, float loosenessVal, float3 centerVal)
            {
                ...
                float3 size = new float3(_adjLength, _adjLength, _adjLength);
            ...
            private void Split()
            {
                ...
                _children[0] = new Node(
                    ...
                    _minSize,
                    _looseness,
                    Center + new float3(-quarter, quarter, -quarter));
