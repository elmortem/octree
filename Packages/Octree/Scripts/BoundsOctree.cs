...
namespace Octree
{
    ...
    public partial class BoundsOctree<T>
    {
        ...
        public Bounds MaxBounds => _rootNode.Bounds;
        ...
        public BoundsOctree(float initialWorldSize, float3 initialWorldPos, float minNodeSize, float loosenessVal)
        {
            ...
            _looseness = math.clamp(loosenessVal, 1.0f, 2.0f);
        ...
        public void Add(T obj, Bounds objBounds)
        {
            ...
            {
                Grow((float3)objBounds.center - _rootNode.Center);
                if (++count > 20)
                {
        ...
        /// </summary>
        /// <seealso cref="IsColliding(UnityEngine.Bounds)"/>
        /// <param name="checkBounds">bounds to check.</param>
        ...
        public bool GetCollidingNonAlloc(List<T> collidingWith, Bounds checkBounds)
        {
            collidingWith.Clear();
            _rootNode.GetColliding(ref checkBounds, collidingWith);
